...
4. Set up environment variables:
   ...
   **Option B: Google Gemini**
   ...
   ```
   Get your free API key from [AI Studio](https://aistudio.google.com/app/apikey)
   
   **Option C: Other Providers**
   - See `.env.example` for Anthropic Claude or OpenAI configurations
   - Edit `utils/call_llm.py` to uncomment your preferred provider
